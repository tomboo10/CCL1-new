...
global.logScore = function(){
    if(global.level === 'easy'){document.getElementById('endScore').innerHTML = "Your Score:" + global.score + "/36"}
    if(global.level === 'middle'){document.getElementById('endScore').innerHTML = "Your Score:" + global.score + "/52"}
    if(global.level === 'hard'){document.getElementById('endScore').innerHTML = "Your Score:" + global.score + "/66"}
}
